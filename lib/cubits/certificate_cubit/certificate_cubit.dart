...
class CertificateCubit extends Cubit<CertificateState> {
 ...
 //This method will share the certificate
  Future<void> saveAndShareCertificate({required UserNameCubit userNameCubit , required BuildContext context}) async {
    late final Uint8List imageBytes ;
    final directory = await getApplicationDocumentsDirectory().then((val) async {
      imageBytes =  (await captureCertificateScreenshot(userNameCubit: userNameCubit, context: context))!;
      return val ;
    } );
