...
const Map<String, List<LessonModel>> allLessons = {
 ...
 <body>
  ...
  "Code Editor": <LessonModel>[
    LessonModel(
        ...
        article: <String>[
          "HTML stands for Hyper Text Markup Language, it is the backbone of web development.  from code editor",
          "It is a simple, easy-to-learn language that describes the structure of web pages and tells the browser how to display the content.",
        ],
        codeExample: "null",
        outPutExample: "null",
 ...
 <body>
     ...
     <h1 style="color:tomato;">This is your first Heading</h1>
     <p>This is your first paragraph.</p>
 </body>
 </html>''',
        outPutExample: "true",
  ...
  "HTML Boilerplate": <LessonModel>[
    LessonModel(
        header: "What is HTML? From HTML Boilerplate",
        article: <String>[
          "HTML5 is the fifth and current version of HTML.",
          "photo1",
          "HTML5 is the fifth and current version of HTML.",
